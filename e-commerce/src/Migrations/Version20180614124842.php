 ...
 */
final class Version20180614124842 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_details (id INT AUTO_INCREMENT NOT NULL, size VARCHAR(255) DEFAULT NULL, weight INT DEFAULT NULL, photo LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', color VARCHAR(255) DEFAULT NULL, price INT NOT NULL, stock INT NOT NULL, discount INT DEFAULT NULL, new TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
